...
Includes Deception Indexing, Grim-Trigger Defense, and Strict Persuasion Engine.
"""
...
class AdvancedAgenticMemory:
    ...
    def __init__(self):
        ...
        self.liar_score = 0  # Counts times opponent lied in message vs move
...
class TrustArenaAgent:
    ...
    def _smart_fallback_decision(self, current_round: int) -> Dict[str, str]:
        ...
        # If Opponent is confirmed Liar or Grim Triggered -> Hard Defect
